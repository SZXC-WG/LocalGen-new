...
void FrameOutput() {
	...
	SetPos(3, rW + 3);
	printf("Setting 'G'->General, 'P'->Plain, 'M'->Mud, 'R'->Rock, 'C'->City.");
	SetPos(4, rW + 3);
	printf("Use 'Q' to stop and enter the numbers.");
	SetPos(5, rW + 3);
	printf("Use 'X' to Loadout the Map and 'L' to Light the block.");
	SetPos(6, rW + 3);
	printf("Use 'E' to exit.");
	SetPos(7, rW + 3);
	printf("Input:");
}
