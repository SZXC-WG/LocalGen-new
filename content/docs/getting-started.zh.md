...
想直接使用 LocalGen，请从 [GitHub Releases](https://github.com/SZXC-WG/LocalGen-new/releases) 下载适合你平台的版本。想体验或参与最新开发，可以从 `master` 分支构建 `6.0.0-dev`。
...
- **macOS：** 使用 `bash scripts/package-macos-dmg.sh build/Release/LocalGen-new.app LocalGen-new.dmg`；请避免直接使用 `macdeployqt ... -dmg`，它可能为本项目生成签名无效的应用包。
